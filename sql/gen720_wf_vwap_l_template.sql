-- ============================================================================
-- Gen 720: Walk-Forward Barrier Optimization — vwap_l Formation (LONG)
--
...
--
-- FORMATION: Single DOWN bar + vwap_close_deviation < p10 (VWAP dislocation)
-- DIRECTION: LONG (buy on next-bar open after signal)
...
-- vwap_l formation: single DOWN bar + vwap_close_deviation < p10 (VWAP dislocation)
