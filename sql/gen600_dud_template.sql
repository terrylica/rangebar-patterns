-- ============================================================================
-- Gen 600: Hybrid Feature Sweep — DOWN-UP-DOWN LONG Template
--
-- PURPOSE: Test hybrid feature pairs (bar-level x lookback/intra) with
-- 3 barrier profiles per query via CROSS JOIN.
-- Forked from gen600_2down_template.sql: failed bounce pattern (D-U-D).
--
-- BASE PATTERN: DOWN-UP-DOWN + ti>p95 + kyle>0 → LONG
-- SHORT ID: dud
--
...
champion_signals AS (
    ...
    WHERE dir_2 = 0 AND dir_1 = 1 AND dir_0 = 0
