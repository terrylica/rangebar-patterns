-- ============================================================================
-- Gen 720: Walk-Forward Barrier Optimization — 2down Formation (LONG)
--
...
--
-- FORMATION: 2 consecutive DOWN bars + trade_intensity > p95 + kyle_lambda > 0
...
-- 2down formation: 2 consecutive DOWN bars + ti>p95 + kyle>0
