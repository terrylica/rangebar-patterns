-- ============================================================================
-- Gen 720: Walk-Forward Barrier Optimization — udd Formation (LONG)
--
...
--
-- FORMATION: UP-DOWN-DOWN (3-bar) + trade_intensity > p95 + kyle_lambda > 0
...
-- udd formation: UP-DOWN-DOWN (3-bar) + ti>p95 + kyle>0
