-- ============================================================================
-- Gen 600: Hybrid Feature Sweep — HIGH-VOL DOWN LONG Template
--
-- PURPOSE: Test hybrid feature pairs (bar-level x lookback/intra) with
-- 3 barrier profiles per query via CROSS JOIN.
-- Forked from gen600_2down_template.sql: single DOWN + vpt>p90 gate.
--
-- BASE PATTERN: Single DOWN bar + volume_per_trade > p90 → LONG
-- SHORT ID: hvd
--
