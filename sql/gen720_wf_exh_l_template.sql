-- ============================================================================
-- Gen 720: Walk-Forward Barrier Optimization — exh_l Formation (LONG)
--
...
--
-- FORMATION: Single DOWN bar + intra_max_drawdown > p75 (intra exhaustion, gated)
...
-- exh_l formation: single DOWN bar + intra_max_drawdown > p75 (intra exhaustion, gated)
