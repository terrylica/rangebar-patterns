-- ============================================================================
-- Gen 720: Walk-Forward Barrier Optimization — 3down Formation (LONG)
--
...
--
-- FORMATION: 3 consecutive DOWN bars + trade_intensity > p95 + kyle_lambda > 0
...
-- 3down formation: 3 consecutive DOWN bars + ti>p95 + kyle>0
