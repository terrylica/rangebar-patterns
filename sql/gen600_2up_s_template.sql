-- ============================================================================
-- Gen 600: Hybrid Feature Sweep — 2-UP SHORT Template
--
-- PURPOSE: Test hybrid feature pairs (bar-level x lookback/intra) with
-- 3 barrier profiles per query via CROSS JOIN.
-- SHORT mirror of gen600_2down_template.sql: barrier math flipped.
--
-- BASE PATTERN: 2 consecutive UP bars + ti>p95 + kyle<0 → SHORT
-- SHORT ID: 2up_s
--
