-- ============================================================================
-- Gen 720: Walk-Forward Barrier Optimization — dud Formation (LONG)
--
...
--
-- FORMATION: DOWN-UP-DOWN (3-bar) + trade_intensity > p95 + kyle_lambda > 0
...
-- dud formation: DOWN-UP-DOWN (3-bar) + ti>p95 + kyle>0
