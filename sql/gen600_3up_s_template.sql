-- ============================================================================
-- Gen 600: Hybrid Feature Sweep — 3-UP SHORT Template
--
-- PURPOSE: Test hybrid feature pairs (bar-level x lookback/intra) with
-- 3 barrier profiles per query via CROSS JOIN.
-- SHORT mirror of gen600_3down_template.sql: barrier math flipped.
--
-- BASE PATTERN: 3 consecutive UP bars + ti>p95 + kyle<0 → SHORT
-- SHORT ID: 3up_s
--
...
champion_signals AS (
    ...
    WHERE dir_2 = 1 AND dir_1 = 1 AND dir_0 = 1
