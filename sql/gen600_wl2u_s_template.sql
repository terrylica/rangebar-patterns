-- ============================================================================
-- Gen 600: Hybrid Feature Sweep — Wickless 2-UP SHORT Template
--
-- PURPOSE: Test hybrid feature pairs (bar-level x lookback/intra) with
-- 3 barrier profiles per query via CROSS JOIN.
-- SHORT mirror of gen600_wl2d_template.sql: barrier math flipped.
-- Wick < 0.001 tolerance for floating point safety.
--
-- BASE PATTERN: 2 consecutive UP bars + both wickless → SHORT
-- SHORT ID: wl2u_s
--
