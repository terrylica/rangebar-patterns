-- ============================================================================
-- Gen 600: Hybrid Feature Sweep — UP + Intra Runup (Gated) SHORT Template
--
-- PURPOSE: Test hybrid feature pairs (bar-level x lookback/intra) with
-- 3 barrier profiles per query via CROSS JOIN.
-- SHORT mirror of gen600_exh_l_template.sql: barrier math flipped.
-- intra_max_runup is Nullable — IS NOT NULL guard required.
--
-- BASE PATTERN: Single UP bar + intra_max_runup > p75 → SHORT
-- SHORT ID: exh_s
--
...
--   __CONFIG_ID__        — Config identifier (e.g., exh_l__ofi_gt_p50__lookback_hurst_lt_p50)
--
