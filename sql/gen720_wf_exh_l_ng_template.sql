-- ============================================================================
-- Gen 720: Walk-Forward Barrier Optimization — exh_l_ng Formation (LONG)
--
...
--
-- FORMATION: Single DOWN bar + intra_max_drawdown IS NOT NULL (exhaustion eligible, no gate)
...
-- exh_l_ng formation: single DOWN bar + intra_max_drawdown IS NOT NULL (exhaustion eligible, no gate)
