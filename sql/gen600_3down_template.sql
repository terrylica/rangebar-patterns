-- ============================================================================
-- Gen 600: Hybrid Feature Sweep — 3-DOWN LONG Template
--
-- PURPOSE: Test hybrid feature pairs (bar-level x lookback/intra) with
-- 3 barrier profiles per query via CROSS JOIN.
-- Forked from gen600_2down_template.sql: adds dir_3 lag for 3-bar pattern.
--
-- BASE PATTERN: 3 consecutive DOWN bars + ti>p95 + kyle>0 → LONG
-- SHORT ID: 3down
--
...
--   __CONFIG_ID__        — Config identifier (e.g., 3down__ofi_gt_p50__lookback_hurst_lt_p50)
--
...
champion_signals AS (
    ...
    WHERE dir_2 = 0 AND dir_1 = 0 AND dir_0 = 0
