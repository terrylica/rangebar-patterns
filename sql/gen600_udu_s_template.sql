-- ============================================================================
-- Gen 600: Hybrid Feature Sweep — UP-DOWN-UP SHORT Template
--
-- PURPOSE: Test hybrid feature pairs (bar-level x lookback/intra) with
-- 3 barrier profiles per query via CROSS JOIN.
-- SHORT mirror of gen600_dud_template.sql: failed pullback pattern (U-D-U).
--
-- BASE PATTERN: UP-DOWN-UP + ti>p95 + kyle<0 → SHORT
-- SHORT ID: udu_s
--
...
--   __CONFIG_ID__        — Config identifier (e.g., dud__ofi_gt_p50__lookback_hurst_lt_p50)
--
...
champion_signals AS (
    ...
    WHERE dir_2 = 1 AND dir_1 = 0 AND dir_0 = 1
