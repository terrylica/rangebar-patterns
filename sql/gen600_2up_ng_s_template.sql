-- ============================================================================
-- Gen 600: Hybrid Feature Sweep — 2-UP No Gate SHORT Template
--
-- PURPOSE: Test hybrid feature pairs (bar-level x lookback/intra) with
-- 3 barrier profiles per query via CROSS JOIN.
-- SHORT mirror of gen600_2down_ng_template.sql: barrier math flipped.
--
-- BASE PATTERN: 2 consecutive UP bars (no ti/kyle gate) → SHORT
-- SHORT ID: 2up_ng_s
--
