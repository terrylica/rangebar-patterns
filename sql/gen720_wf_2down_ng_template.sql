-- ============================================================================
-- Gen 720: Walk-Forward Barrier Optimization — 2down_ng Formation (LONG)
--
...
--
-- FORMATION: 2 consecutive DOWN bars (no gate — no ti/kyle filter)
...
-- 2down_ng formation: 2 consecutive DOWN bars (no gate — no ti/kyle filter)
