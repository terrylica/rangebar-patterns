-- ============================================================================
-- Gen 600: Hybrid Feature Sweep — DOWN + Intra Exhaustion (Gated) LONG Template
--
-- PURPOSE: Test hybrid feature pairs (bar-level x lookback/intra) with
-- 3 barrier profiles per query via CROSS JOIN.
-- Forked from gen600_2down_template.sql: intra_max_drawdown > p75 gate.
-- intra_max_drawdown is Nullable — IS NOT NULL guard required.
--
-- BASE PATTERN: Single DOWN bar + intra_max_drawdown > p75 → LONG
-- SHORT ID: exh_l
--
