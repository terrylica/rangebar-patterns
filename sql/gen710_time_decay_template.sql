...
barrier_params AS (
    SELECT
        ...
        s.entry_price * (1.0 - __SL_WIDE__ * (__THRESHOLD_DBPS__ / 100000.0)) AS sl_wide_price,
        s.entry_price * (1.0 - __SL_TIGHT__ * (__THRESHOLD_DBPS__ / 100000.0)) AS sl_tight_price,
