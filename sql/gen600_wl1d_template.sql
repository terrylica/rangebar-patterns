-- ============================================================================
-- Gen 600: Hybrid Feature Sweep — Single Wickless DOWN LONG Template
--
-- PURPOSE: Test hybrid feature pairs (bar-level x lookback/intra) with
-- 3 barrier profiles per query via CROSS JOIN.
-- Forked from gen600_2down_template.sql: single bar with zero opposite wick.
-- Bar opened at its extreme and moved straight to the other extreme.
--
-- BASE PATTERN: Single DOWN bar + wickless → LONG
-- SHORT ID: wl1d
--
...
--   __CONFIG_ID__        — Config identifier (e.g., wl1d__ofi_gt_p50__lookback_hurst_lt_p50)
--
