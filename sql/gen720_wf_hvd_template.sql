-- ============================================================================
-- Gen 720: Walk-Forward Barrier Optimization — hvd Formation (LONG)
--
...
--
-- FORMATION: Single DOWN bar + volume_per_trade > p90 (high volume)
...
-- hvd formation: single DOWN bar + volume_per_trade > p90 (high volume)
