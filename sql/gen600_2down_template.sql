-- ============================================================================
-- Gen 600: Hybrid Feature Sweep — 2-DOWN (Champion) LONG Template
--
-- PURPOSE: Test hybrid feature pairs (bar-level x lookback/intra) with
-- 3 barrier profiles per query via CROSS JOIN. Canonical LONG template;
-- other patterns fork from this with modified champion_signals WHERE.
--
...
--   __CONFIG_ID__        — Config identifier (e.g., 2down__ofi_gt_p50__lookback_hurst_lt_p50)
--
