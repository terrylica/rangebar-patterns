-- ============================================================================
-- Gen 600: Hybrid Feature Sweep — 2-DOWN No Gate LONG Template
--
-- PURPOSE: Test hybrid feature pairs (bar-level x lookback/intra) with
-- 3 barrier profiles per query via CROSS JOIN.
-- Forked from gen600_2down_template.sql: NO ti/kyle gate (high coverage).
--
-- BASE PATTERN: 2 consecutive DOWN bars (no ti/kyle gate) → LONG
-- SHORT ID: 2down_ng
--
...
--   __CONFIG_ID__        — Config identifier (e.g., 2down_ng__ofi_gt_p50__lookback_hurst_lt_p50)
--
