...
```bash
OPENDEVIATIONBAR_RANK_CUT_COVERAGE=85 OPENDEVIATIONBAR_RANK_CUT_DSR=95 OPENDEVIATIONBAR_RANK_CUT_EVALUE=95 OPENDEVIATIONBAR_RANK_CUT_HEADROOM=25 OPENDEVIATIONBAR_RANK_CUT_KELLY=35 OPENDEVIATIONBAR_RANK_CUT_OMEGA=70 OPENDEVIATIONBAR_RANK_CUT_OU_RATIO=60 OPENDEVIATIONBAR_RANK_CUT_RACHEV=90 OPENDEVIATIONBAR_RANK_CUT_REGULARITY_CV=65 OPENDEVIATIONBAR_RANK_CUT_SL_CDAR=50 OPENDEVIATIONBAR_RANK_CUT_TAMRS=30 mise run eval:rank
```
