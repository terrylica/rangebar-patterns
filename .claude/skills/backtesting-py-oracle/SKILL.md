...
**Companion skills**: [clickhouse-antipatterns](../clickhouse-antipatterns/SKILL.md) (SQL correctness) | [sweep-methodology](../sweep-methodology/SKILL.md) (sweep design)
...
| Topic                       | Reference                                                                                           |
| --------------------------- | --------------------------------------------------------------------------------------------------- |
| Anti-patterns SKILL         | [clickhouse-antipatterns](../clickhouse-antipatterns/SKILL.md) (AP-16)                              |
| Backtest CLAUDE.md          | [backtest/CLAUDE.md](/backtest/CLAUDE.md)                                                           |
| Oracle validation findings  | [findings/2026-02-12-gen600-oracle-validation.md](/findings/2026-02-12-gen600-oracle-validation.md) |
...
| GitHub Issue                | [Issue #14](https://github.com/terrylica/rangebar-patterns/issues/14)                               |
